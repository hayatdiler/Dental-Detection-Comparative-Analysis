...
The dataset used in this research is derived from the Tufts Dental Database, consisting of 968 high-quality panoramic radiographs. All images were meticulously annotated by dental experts according to FDI (Fédération Dentaire Internationale) standards.
...
Bu çalışmada kullanılan veri seti, Tufts Dental Database kaynaklı olup, toplam 968 adet yüksek çözünürlüklü panoramik röntgen görüntüsünden oluşmaktadır. Tüm veriler, diş hekimliği uzmanları tarafından FDI (Fédération Dentaire Internationale) standartlarına uygun şekilde titizlikle etiketlenmiştir
* **Sınıflar (Toplam 8):**
